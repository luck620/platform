...
public interface StudentRepository extends JpaRepository<Student,Integer> {
    ...
    List<Student> findStudentAll(Pageable pageable);
    ...
    List<Student> findAllByOthers(String name, String sno, String phone, String mail, String grade, Pageable pageable);
